 ...
 <footer class="footer">
     <div class="d-sm-flex justify-content-center justify-content-sm-between">
         <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Copyright © 2021. Daily.</span>
     </div>
 </footer>
 <!-- partial -->
 </div>
 ...
 <!-- <script src="<?= base_url()?>./assets/Admin/vendors/mdi/css/materialdesignicons.css.map"></script> -->
 ...
 <script type="text/javascript" src="<?= base_url()?>./assets/Admin/jquery/jquery.min.js"></script>
 <!-- End custom js for this page-->
 </body>

 </html>
 http://localhost/ternakku/assets/Admin/vendors/mdi/css/materialdesignicons.css.map